 ...
 * 支付回调的响应内容类。
 */
public class UcPayResponse {
    String ver = "";
    String sign = "";
    UcPayResponseData data;
    ...
    public UcPayResponseData getData() {
        return this.data;
    }

    public void setData(UcPayResponseData data) {
        this.data = data;
    }

    public class UcPayResponseData {
